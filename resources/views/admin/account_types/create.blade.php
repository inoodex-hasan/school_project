                ...
                <div class="col-12 col-md-8 offset-md-2">
                    <div class="card shadow-sm border-0">
                        <div
                            ...
                            <h4 class="mb-0 fw-semibold text-dark">Add New Account Type</h4>
                            ...
                            <form action="{{ route('admin.account_types.store') }}" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="name" id="name"
                                        ...
                                        placeholder="Enter account type name" value="{{ old('name') }}" required>
                                    @error('name')
                                ...
                                <div class="d-flex justify-content-end align-items-center">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-lg px-4">Save Account Type</button>
                                </div>
                            </form>
                        </div>
                    </div>
