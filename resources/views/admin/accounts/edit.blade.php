                ...
                <div class="col-12 col-md-8 offset-md-2">
                    <div class="card shadow-sm border-0">
                        <div class="card-header d-flex justify-content-between align-items-center py-3 bg-white border-bottom">
                            <h4 class="mb-0 fw-semibold text-dark">Edit Account Entry</h4>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.accounts.update', $account->id) }}" method="POST">
                                ...
                                <div class="row">
                                        ...
                                        <select name="student_id" id="student_id"
                                            ...
                                            @foreach ($students as $student)
                                                <option value="{{ $student->id }}"
                                                    {{ old('student_id', $account->student_id) == $student->id ? 'selected' : '' }}>
                                                    {{ $student->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="date" name="date" id="date"
                                            ...
                                            value="{{ old('date', $account->date->format('Y-m-d')) }}" required>
                                        @error('date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <select name="type" id="type"
                                            ...
                                            <option value="income"
                                                {{ old('type', $account->type) == 'income' ? 'selected' : '' }}>Income
                                            </option>
                                            <option value="expense"
                                                {{ old('type', $account->type) == 'expense' ? 'selected' : '' }}>Expense
                                            </option>
                                        </select>
                                        @error('type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="amount" id="amount" step="0.01"
                                            ...
                                            placeholder="0.00" value="{{ old('amount', $account->amount) }}" required>
                                    </div>
                                    @error('amount')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <textarea name="note" id="note" rows="3" class="form-control @error('note') is-invalid @enderror">{{ old('note', $account->note) }}</textarea>
                                    @error('note')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="d-flex justify-content-end align-items-center gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-lg px-4">Update Entry</button>
                                </div>
                            </form>
                        </div>
                    </div>
