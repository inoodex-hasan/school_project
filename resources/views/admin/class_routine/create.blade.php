                ...
                <div class="col-12 col-md-8 offset-md-2">
                    <div class="card shadow-sm border-0">
                        <div class="card-header d-flex justify-content-between align-items-center py-3 bg-white border-bottom">
                            <h4 class="mb-0 fw-semibold text-dark">Add Class Routine</h4>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.class_routine.store') }}" method="POST">
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <select name="day" id="day"
                                            ...
                                            @foreach (['Saturday', 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday'] as $day)
                                                <option value="{{ $day }}"
                                                    {{ old('day') == $day ? 'selected' : '' }}>{{ $day }}</option>
                                            @endforeach
                                        </select>
                                        @error('day')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="d-flex justify-content-end align-items-center">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-lg px-4">Save Routine</button>
                                </div>
                            </form>
                        </div>
                    </div>
