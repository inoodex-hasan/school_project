                ...
                <div class="col-12 col-md-8 offset-md-2">
                    <div class="card">
                        <div
                            ...
                            <h4 class="mb-0 fw-semibold text-dark">Add New Photo</h4>
                            ...
                            <form action="{{ route('admin.gallery.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label for="title">Photo Title <span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="file">Upload Photo <span class="text-danger">*</span></label>
                                ...
                                <div class="d-flex justify-content-end align-items-center mt-4">
                                    <button type="submit" class="btn btn-primary btn-lg px-4">Save Photo</button>
                                    <a href="{{ route('admin.gallery.index') }}"
