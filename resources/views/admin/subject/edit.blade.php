                ...
                <div class="col-12 col-md-8 offset-md-2">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center py-3 bg-white border-bottom">
                            <h4 class="mb-0 fw-semibold text-dark">Edit Subject: {{ $subject->name }}</h4>
                            <div class="card-header-action">
                                <a href="{{ route('admin.subject.index') }}" class="btn btn-primary px-4 rounded-2 shadow-sm">
                                    Back to List
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.subject.update', $subject->id) }}" method="POST">
                                ...
                                <div class="d-flex justify-content-end align-items-center mt-4">
                                    <button type="submit" class="btn btn-primary btn-lg px-4">Update Subject</button>
